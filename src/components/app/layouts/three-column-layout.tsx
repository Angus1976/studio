...
const Left = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return <div className={cn("lg:col-span-3 h-full hidden lg:flex flex-col gap-6", className)}>{children}</div>;
};

const Main = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return <div className={cn("lg:col-span-5 h-full flex flex-col gap-6", className)}>{children}</div>;
};
