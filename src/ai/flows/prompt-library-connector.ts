...
const promptLibrary: Record<string, { title: string; content: string }> = {
  ...
  'knowledge-base-assistant': {
    title: '企业智能知识库助理',
    content: 'You are an enterprise knowledge base assistant. Based on the provided enterprise knowledge base context and the user\'s question, provide an accurate and comprehensive answer. If the information is not in the knowledge base, state that clearly. Context: [User-provided knowledge base data]. Question: {{{userContext}}}',
  }
};
